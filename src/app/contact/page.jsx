    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="text-center text-secondary mb-12">
          Kirimkan pesan kepada kami melalui form di bawah ini
        </p>
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="pesan" className="block text-secondary font-semibold mb-2">
                Pesan
              </label>
              <textarea
                id="pesan"
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-secondary hover:bg-secondary/90 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
              >
